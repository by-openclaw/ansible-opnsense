...
> 52 modules across 12 scopes. Requires OPNsense >= 26.1.
...
| `proto` | str | no | ethertype8021q | `ethertype8021q` or `ethertype8021ad` |
...
| `interface` | str | yes | -- | Interface |
| `mode` | str | yes | -- | `ipalias`, `carp`, `proxyarp`, or `other` |
...
### opnsense_routing_gateway

Manage gateways. **PLANNED -- not yet implemented.**
...
### opnsense_routing_route

Manage static routes. **PLANNED -- not yet implemented.**
...
| `transport` | str | no | udp4 | `udp4`, `tcp4`, `udp6`, or `tcp6` |
