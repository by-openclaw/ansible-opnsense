...
"""Ansible module for OPNsense Manage OPNsense Monit alerts."""
...
short_description: Manage OPNsense Monit alerts
version_added: "0.3.0"
description:
  - Thin wrapper around lib-opnsense MonitAlertManager.ensure().
...
def main() -> None:
    ...
    if module.params["recipient"]:
        params["recipient"] = module.params["recipient"]
