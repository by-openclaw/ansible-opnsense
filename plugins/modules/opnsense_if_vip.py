...
"""Ansible module for OPNsense Manage OPNsense Virtual IPs."""
...
short_description: Manage OPNsense Virtual IPs
version_added: "0.3.0"
description:
...
def main() -> None:
    ...
    params: dict = {"descr": module.params["descr"]}
