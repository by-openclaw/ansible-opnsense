...
"""Ansible module for OPNsense Manage OPNsense gateways."""

from __future__ import annotations

DOCUMENTATION = r"""
---
module: opnsense_gw_config
short_description: Manage OPNsense gateways
version_added: "0.3.0"
description:
  - Thin wrapper around lib-opnsense GwConfigManager.ensure().
...
- name: Ensure resource
  by_systems.opnsense.opnsense_gw_config:
    host: "{{ opn_host }}"
    key: "{{ opn_key }}"
    secret: "{{ opn_secret }}"
    name: "example"
...
def main() -> None:
    ...
    run_module(module, GwConfigManager, params)
