...
"""Ansible module opnsense_dnsmasq_service — thin wrapper on lib-opnsense."""

from __future__ import annotations

DOCUMENTATION = r"""
---
module: opnsense_dnsmasq_service
short_description: Control the OPNsense Dnsmasq service
version_added: "0.5.0"
description:
  - Start, stop or reconfigure the Dnsmasq service — lib-opnsense DnsmasqServiceManager.ensure().
  - Stop it to free 67/547 for Kea.
...
EXAMPLES = r"""
- name: Dnsmasq — apply configuration
  by_systems.opnsense.opnsense_dnsmasq_service:
    host: "{{ opn_host }}"
    key: "{{ opn_key }}"
    secret: "{{ opn_secret }}"
    state: reconfigured
...
def main() -> None:
    ...
    run_module(module, DnsmasqServiceManager, {})
